...
Blockly.Blocks.colour={};Blockly.Blocks.colour.HUE=20;Blockly.Blocks.colour_picker={init:function(){this.jsonInit({message0:"%1",args0:[{type:"field_colour",name:"COLOUR",colour:"#ff0000"}],output:"Colour",colour:Blockly.Blocks.colour.HUE,tooltip:Blockly.Msg.COLOUR_PICKER_TOOLTIP,helpUrl:Blockly.Msg.COLOUR_PICKER_HELPURL})}};
...
function dynamicRooms() {
	var options=[];
	var scenecontroller = $('#blocklyDiv').data("scenecontroller") || 0;	// default controller to 0 (main)
	...
	options.push([_T("No Room"),NULL_ROOM])
	return options;
}
...
Blockly.Blocks['device'] = {
  ...
  updateName_: function(room) {
	...
	var devices = $.grep( MultiBox.getDevicesSync() , function(d) {
		return (d.room==elems[1]) || (d.room==undefined && elems[1]=="0");
	} );
