...
Localization.init( {
	...
	"State":"Etat",
	"State Properties":"Propriétés d'Etat",
	"State Name":"Nom d'Etat",
	"State Actions":"Actions d'Etat",
	"On Enter":"A l'Entrée",
	"On Exit":"A la Sortie",
	...
	"if a menu has more entries than this number then show the menu entries in 2 columns":"Montrer les menus sur 2 colonnes si le nombre d items depasse ce nombre",
	...
	"Editor Control":"Controle de l\"éditeur",
	"Editor Theme":"Theme de l\"éditeur",
	"Editor font size in pixels":"Taille de caracteres de l\"éditeur en pixel",
	"Editor Font Size":"Taille de caracteres de l\"éditeur",
	"EditorFontSize:Editor font size in pixels":"EditorFontSize:Taille de caracteres de l\"éditeur en pixel",
	"info":"info",
	"Bag":"Sac",
	"Import/Export":"Import/Export",
	"Variables Bag":"Sac de Variables",
	"No data to display":"Pas de donnée a afficher",
	"Schedules":"Programmes",
	"Duration (sec)":"Durée (sec)",
	"None":"Rien",
	"Only in the following mode(s)":"Seulement dans le(s) modes suivants",
	"Record":"Enregistre",
	...
	"Once registered you will get:<ul><li>Access to all the releases and auto update mechanism (not available to non registered users)</li><li>Removal of unregistered welcome message, as well as license message in the footer</li></ul>":"Une fois enregistré, vous aurez accès aux:<ul><li>Nouvelles versions avec le mecanisme de <b>mise a jour automatique</b> résèrvé aux utilisateurs enregistrés</li><li><b>Absence</b> du message d'alerte de version non enregistrée en haut de page et dans le pied de page</li></ul>",
	"Resellers or Integrators are welcome to contact me for eventual commercial agreements.":"Les revendeurs / integrateurs qui souhaiteraient utiliser ce logiciel dans leurs solutions peuvent me contacter pour passer un accord commercial.",
