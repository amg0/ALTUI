...
local htmlScripts = [[
	...
	<script type="text/javascript" src="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js" crossorigin="anonymous"></script>
...
local defaultBootstrapPath = "//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css"
